...
class EffNet(nn.Module):
    ...
    def __init__(self):
        ...
        assert cfg.TRAIN.DATASET in ["imagenet", "custom"], err_str.format(cfg.TRAIN.DATASET)
        assert cfg.TEST.DATASET in ["imagenet", "custom"], err_str.format(cfg.TEST.DATASET)
